# main.py (نسخه نهایی برای پروژه جدید)
import requests
import time
import json
import logging
...
def get_strategy_signal():
    """سیگنال آربیتراژ را از API استراتژی دریافت می‌کند."""
    try:
...
# --- حلقه اصلی برای پیدا کردن سیگنال و ثبت سفارش خرید ---
...
if __name__ == "__main__":
    ...
    if load_market_precisions():
        # این ربات فقط به یک ترد برای بررسی سیگنال‌ها نیاز دارد
